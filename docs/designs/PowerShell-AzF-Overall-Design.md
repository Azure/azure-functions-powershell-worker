...
However, the design should accommodate more complex manifests that refer to multiple modules (including non-Az modules), and allow specifying exact module versions.
