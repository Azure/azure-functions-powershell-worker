...
namespace Microsoft.Azure.Functions.PowerShellWorker.Commands
{
    ...
    public sealed class TracePipelineObjectCommand : PSCmdlet
    {
        ...
        static TracePipelineObjectCommand()
        {
            ...
            s_pwsh.AddCommand(Utils.OutStringCmdletInfo).AddParameter("Stream", Utils.BoxedTrue)
                  .AddCommand(Utils.WriteInformationCmdletInfo).AddParameter("Tags", "__PipelineObject__");
        }
