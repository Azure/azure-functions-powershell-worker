...
* [.NET 10.0 SDK](https://www.microsoft.com/net/download/visual-studio-sdks)
...
```powershell
Copy-Item -Recurse -Force ./src/bin/Debug/net10.0/publish/ "/usr/local/Cellar/azure-functions-core-tools/$(func --version)/workers/powershell/7.6"
Copy-Item -Recurse -Force ./src/bin/Debug/net10.0/publish/worker.config.json "/usr/local/Cellar/azure-functions-core-tools/$(func --version)/workers/powershell"
```
...
```powershell
Copy-Item -Recurse -Force ./src/bin/Debug/net10.0/publish/ "<Azure Functions Host Root>/src/WebJobs.Script.WebHost/bin/Debug/net10.0/workers/powershell/7.6"
Copy-Item -Force ./src/bin/Debug/net10.0/publish/worker.config.json "<Azure Functions Host Root>/src/WebJobs.Script.WebHost/bin/Debug/net10.0/workers/powershell"
```

Then you can start the host by running:
```sh
dotnet ./src/WebJobs.Script.WebHost/bin/Debug/net10.0/Microsoft.Azure.WebJobs.Script.WebHost.dll
```
...
`azure-functions-powershell-worker/src/bin/Debug/net10.0/publish`
